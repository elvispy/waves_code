function S = sweeper_omega_experiments
...
%subplot(3,1,1);
figure;
plot(xOmega, Tthr, 'o-','LineWidth',1.2,'MarkerSize',5);
set(gca,'XScale','linear'); grid on; set(gca,'FontSize',13);
xlabel('f (Hz)'); ylabel('Thrust/d (N/m)');
title('Thrust');



% (b) Amplitude vs EI/EI0
figure;
plot(xOmega, 1e3*E1,   'o-','LineWidth',1.2,'MarkerSize',5); hold on;
plot(xOmega, 1e3*Eend, 'x-','LineWidth',1.2,'MarkerSize',5); hold on;
set(gca,'XScale','linear', 'Yscale', 'linear'); grid on; set(gca,'FontSize',13);
xlabel('f (Hz)'); ylabel('Amplitude (mm)');
title('Amplitude (mm)');

return
% (c) Endpoint amplitudes vs EI/EI0
subplot(3,1,3);
plot(xOmega, E1,   'o-','LineWidth',1.2,'MarkerSize',5,'DisplayName','|eta(1)|'); hold on;
plot(xOmega, Eend, 's-','LineWidth',1.2,'MarkerSize',5,'DisplayName','|eta(end)|');
...
plot(xOmega, Tn,     '--','LineWidth',3,'MarkerSize',5,'DisplayName','Thrust/d'); hold on;
plot(xOmega, TnPn,   '--','LineWidth',2,'MarkerSize',5,'DisplayName','Thrust/Power');
plot(xOmega, E1n,     '-','LineWidth',3,'MarkerSize',10,'DisplayName','|eta(1)|');
plot(xOmega, Eendn,   '-','LineWidth',1.5,'MarkerSize',5,'DisplayName','|eta(end)|');
