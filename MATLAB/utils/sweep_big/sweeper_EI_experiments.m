function S = sweeper_EI_experiments
...
EI_list = base.EI * (10.^linspace(-2, 0, 21));
...
figure;
plot(xEI, 1e3*E1,   'o-','LineWidth',1.2,'MarkerSize',5); hold on;
plot(xEI, 1e3*Eend, 'x-','LineWidth',1.2,'MarkerSize',5); hold on;
set(gca,'XScale','log', 'Yscale', 'linear'); grid on; set(gca,'FontSize',13);
xlabel('EI/EI_0'); ylabel('Amplitude (mm)');
title('Amplitude (mm)');
