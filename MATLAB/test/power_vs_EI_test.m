...
% power vs EI
figure(2); clf;
plot([S.EI]./base.EI, [S.thrust_N]./[S.power], 'o-','MarkerSize',6,'LineWidth',1.2, 'DisplayName', 'Pressure integral');
%plot([S.EI]./base.EI, [S.power],      '--','MarkerSize',6,'LineWidth',2.0, 'DisplayName', 'LH');
xlabel('EI/EI0'); ylabel('Thrust/d / power (N/m)');
set(gca,'FontSize',14); grid on; legend; set(gca, 'YScale', 'linear', 'XScale', 'log');
title('THrust per unit depth per exerted power.');


figure(3); clf; 
hold off; plot([S.EI]./base.EI, [S.thrust_N] ./ [S.power], 'o-','MarkerSize',6,'LineWidth',1.2, 'DisplayName', 'Thrust/Power'); hold on;
plot([S.EI]./base.EI, 6*[S.thrust_N], '--','MarkerSize',6,'LineWidth',1.7, 'DisplayName', '6*Thrust'); hold on;
xlabel('EI/EI0'); ylabel('Thrust/d / power (s/m^2)');
set(gca,'FontSize',14); grid on; legend; set(gca, 'YScale', 'linear', 'XScale', 'log');
title('THrust per unit depth per exerted power.');
