...
base = struct( ...
    ...
    'L_raft',L_raft, 'L_domain', 3*L_raft, ...    
    'motor_position',0.24*L_raft/2, 'd',0.03, ...
...
%for i = 1:numel(S)
%    plot(ax, S(i).x(S(i).args.x_contact), abs(S(i).eta(S(i).args.x_contact)), ...
%        'k--', 'LineWidth', 2 ,'DisplaName');
%end
