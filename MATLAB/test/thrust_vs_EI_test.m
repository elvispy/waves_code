...
base = struct( ...
    ...
    'L_domain', 3*L_raft, 'EI',100*3.0e9*3e-2*(9.9e-4)^3/12, 'rho_raft',0.018*10, ...
    'domainDepth',0.5, 'n',215, 'M',200, ...
    'motor_inertia',0.13e-3*2.5e-3, 'BC','radiative', ...
    'omega',2*pi*10, 'ooa', 4);

% EI values to test (multiplicative sweep)
EI_list = base.EI * [0.1, 1, 10];
...
% Thrust vs EI
figure(2); clf;
plot([S.EI], [S.thrust_N], 'o-','MarkerSize',6,'LineWidth',1.2);
xlabel('EI'); ylabel('Thrust (N)');
