function analyze_modal_decomposition_along_beam_curve(saveDir)
...
%
% This is the beam-end analogue of analyze_modal_decomposition_along_curve.m. The white curve
...
for i = 1:numel(required)
    if ~isfield(St, required{i})
        error('analyze_modal_decomposition_along_beam_curve:MissingField', ...
...
outfile = fullfile(saveDir, 'analyze_modal_decomposition_along_beam_curve.pdf');
